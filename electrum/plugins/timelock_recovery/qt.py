...
class Plugin(TimelockRecoveryPlugin):
    ...
    def setup_dialog(self, window):
        ...
        self.d = WindowModalDialog(window, "Timelock Recovery")
        ...
        # Create the labels.
        instructions_label = QLabel(_("Click the button above or type an existing timelock recovery code in the box below."))
        ...
        # Create the buttons.
        create_button = QPushButton(_("Create a new Timelock Recovery noise file"))
    ...
    def get_path_to_timelock_recovery_file(self, ext: str= '') -> str:
    ...
    def bcrypt(self, dialog):
        ...
        dialog.show_message(''.join([_("{} encrypted for Revealer {}_{} saved as PNG and PDF at: ").format(self.was, version, code_id),
                                     "<b>", self.get_path_to_timelock_recovery_file(), "</b>", "<br/>",
    ...
    def bdone(self, dialog):
        ...
        dialog.show_message(''.join([_("Digital Revealer ({}_{}) saved as PNG and PDF at:").format(version, code_id),
                                     "<br/>","<b>", self.get_path_to_timelock_recovery_file(), '</b>']),
                            rich_text=True)
    ...
    def seed_img(self, is_seed = True):
        ...
        font = QFont('DejaVu Sans Mono', fontsize, QFont.Weight.Bold)
    ...
    def make_revealer(self):
        ...
        self.filename_prefix = 'timelock_recovery_'
        revealer.save(self.get_path_to_timelock_recovery_file('.png'))
    ...
    def make_cypherseed(self, img, rawnoise, calibration=False, is_seed = True):
        ...
        if not calibration:
            ...
            cypherseed.save(self.get_path_to_timelock_recovery_file('.png'))
    ...
    def toPdf(self, image):
        ...
        printer.setOutputFileName(self.get_path_to_timelock_recovery_file('.pdf'))
    ...
    def calibration_pdf(self, image):
        ...
        painter.begin(printer)
        painter.drawImage(553,533, image)
        font = QFont('DejaVu Sans Mono', 10, QFont.Weight.Bold)
        painter.setFont(font)
        painter.drawText(254,277, _("Calibration sheet"))
        font = QFont('DejaVu Sans Mono', 7, QFont.Weight.Bold)
        painter.setFont(font)
